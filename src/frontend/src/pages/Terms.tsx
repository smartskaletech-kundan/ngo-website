...
export default function Terms() {
  return (
    <Layout
      ...
      pageDescription="Terms governing the use of Anumaya Sansthan's website and services."
    >
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="bg-card rounded-card shadow-card p-8 md:p-12">
            ...
            <p className="text-foreground/75 leading-relaxed mb-6">
              By accessing or using the Anumaya Sansthan website, you agree to
            ...
            <p className="text-foreground/75 leading-relaxed mb-6">
              ...
              contributions to Anumaya Sansthan's programs. Donations are used
              for the stated purposes. Receipts are issued for all donations.
              Donations above ₹500 are eligible for 80G tax deduction, subject
              to applicable laws.
            </p>
            ...
            <p className="text-foreground/75 leading-relaxed mb-6">
              ...
              of Anumaya Sansthan unless otherwise credited. Unauthorized
            ...
            <p className="text-foreground/75 leading-relaxed mb-6">
              This website is provided on an "as-is" basis. Anumaya Sansthan
              makes no warranties, expressed or implied, regarding the accuracy,
              completeness, or availability of information on this site.
            </p>
            ...
            <p className="text-foreground/75 leading-relaxed mb-6">
              Anumaya Sansthan shall not be liable for any indirect, incidental,
